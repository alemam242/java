...
//import java.util.*;  /// ETA IMPORT KORLE util er SOKOL FUNCTION IMPORT HOYE JAI
public class Array_List {
    public static void main(String[] args) {
        /**
         * Functions are in ArrayList
         * size()
         * add()
         * remove()
         * removrAll()
         ...
         * equals()
         * addAll()
         * Collections.sort(array_variable) /// sort data in ascending order
         * Collection.sort(array_variable,collection.reverseOrder()) // sort data in
         * descending order
         */
